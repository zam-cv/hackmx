...
export default function EventDetails() {
  ...
  return (
    <>
      <div>
        <div className="md:w-[40rem] bg-p-secondary-background p-10 pt-16 rounded-sm flex flex-col gap-5 relative">
              ...
              {registrationDetails === null ? (
                ...
                <div className="flex flex-col gap-3">
                  <p className="text-p-secondary-text text-sm flex items-center justify-center gap-2">
                    <span className="font-bold">¿Requieres autobús? </span>{" "}
                    <Checkbox
                      checked={withBus}
                      onClick={() => setWithBus(!withBus)}
                    />
                  </p>
      ...
      <div className="grid lg:grid-cols-2 lg:gap-10 gap-16">
        <div className="flex flex-col gap-10">
          ...
          <p className="text-p-secondary-text">{event.description}</p>
        </div>
        ...
        {event.map_url && (
          <iframe
            ...
            style={{
              border: "0",
              filter:
                "contrast(0.9) invert(1) sepia(0.5) saturate(1.2) hue-rotate(180deg)",
            }}
